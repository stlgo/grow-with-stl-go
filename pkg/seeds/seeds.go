	...
	inventoryTables = map[string]*configs.Table{
		"seeds": {
			...
			Defaults: map[string]string{
				...
				0, 2.67, 20, 100, '/images/onions/aisa_craig.jpg')`, uuid.New().String()),
				...
				0, 4.58, 50, 100, '/images/peppers/gree_bell.jpg')`, uuid.New().String()),
				...
				"cherokee purple": fmt.Sprintf(`insert or ignore into seeds values ('%s', 'Tomato', 'Solanum', 'lycopersicum', 'Zapotec', 'tomato',
